...
This markdown content is based on **Appendix B** of the TSP Speech Database, which contains the **Harvard Sentences**. These are phonetically balanced sentences used to record utterances for researchers and developers to compare results from a common database.

The sentences are organized into **72 lists**, each containing **10 sentences**.

***

# Harvard Sentences (Appendix B)
...
### List 6
1. The frost air passed through the coat.
...
2. He **smoked** a big pipe with strong contents.
...
*Note: In this list, "smoke" was changed to the more grammatical "smoked".*
...
### List 36
1. Pour stew from the pot into the plate.
...
8. The lake sparkled in the red hot son.
...
6. The drop of the rain made a pleasant sound.
...
10. A cone cost five cents on Mondays.
...
4. We need an end of all such matters.
...
7. A quart if milk is water for the most part.
...
5. Breathe deep and smell the piney air.
...
2. A cruise in warm waters in a sleep yacht is fun.
